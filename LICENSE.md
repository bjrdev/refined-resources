...
### 1. PERMITTED USE
* **Personal and Commercial Use:** You are free to use these assets and scripts in your own Roblox games, projects, and experiences, including monetized ones.
* **Modification for Personal Use:** You are allowed to modify (remix) the code and assets to fit the specific needs of your project.
...
*THE SOFTWARE AND ASSETS ARE PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED. IN NO EVENT SHALL THE AUTHORS BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIABILITY.*
